Contributing to WINCASHGOLD Core
============================

The WINCASHGOLD Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/wincashgold-project/wincashgold/blob/master/doc/translation_process.md)
...
The following applies to code changes to the WINCASHGOLD Core project, and is not to be
confused with overall WINCASHGOLD Network Protocol consensus changes.

Whether a pull request is merged into WINCASHGOLD Core rests with the project merge
...
Patches that change WINCASHGOLD consensus rules are considerably more involved than
...
Where a patchset proposes to change the WINCASHGOLD consensus, it must have been
...
The project leader is the release manager for each WINCASHGOLD Core release.
