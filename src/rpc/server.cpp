...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop WINCASHGOLD server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "WINCASHGOLD server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WINCASHGOLD features */
        {"wincashgold", "listmasternodes", &listmasternodes, true, true, false},
        {"wincashgold", "getmasternodecount", &getmasternodecount, true, true, false},
        {"wincashgold", "masternodeconnect", &masternodeconnect, true, true, false},
        {"wincashgold", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"wincashgold", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"wincashgold", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"wincashgold", "masternodecurrent", &masternodecurrent, true, true, false},
        {"wincashgold", "masternodedebug", &masternodedebug, true, true, false},
        {"wincashgold", "startmasternode", &startmasternode, true, true, false},
        {"wincashgold", "createmasternodekey", &createmasternodekey, true, true, false},
        {"wincashgold", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"wincashgold", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"wincashgold", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"wincashgold", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"wincashgold", "getmasternodescores", &getmasternodescores, true, true, false},
        {"wincashgold", "preparebudget", &preparebudget, true, true, false},
        {"wincashgold", "submitbudget", &submitbudget, true, true, false},
        {"wincashgold", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"wincashgold", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"wincashgold", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"wincashgold", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"wincashgold", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"wincashgold", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"wincashgold", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"wincashgold", "checkbudgets", &checkbudgets, true, true, false},
        {"wincashgold", "mnsync", &mnsync, true, true, false},
        {"wincashgold", "spork", &spork, true, true, false},
        {"wincashgold", "getpoolinfo", &getpoolinfo, true, true, false},
...
//        {"zerocoin", "getzwccgseed", &getzwccgseed, false, false, true},
//        {"zerocoin", "setzwccgseed", &setzwccgseed, false, false, true},
//        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
//        {"zerocoin", "searchdzwccg", &searchdzwccg, false, false, true},
//        {"zerocoin", "dzwccgstate", &dzwccgstate, false, false, true},
...
{
    return "> wincashgold-cli " + methodname + " " + args + "\n";
}
