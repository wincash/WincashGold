...
#ifndef WINCASHGOLD_ZWCCGWALLET_H
#define WINCASHGOLD_ZWCCGWALLET_H
...
public:
    CzWCCGWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZWCCG(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZWCCG(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //WINCASHGOLD_ZWCCGWALLET_H
