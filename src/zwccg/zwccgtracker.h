...
#ifndef WINCASHGOLD_ZWCCGTRACKER_H
#define WINCASHGOLD_ZWCCGTRACKER_H
...
public:
    CzWCCGTracker(std::string strWalletFile);
    ~CzWCCGTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzWCCGWallet* zWCCGWallet = NULL);
...
#endif //WINCASHGOLD_ZWCCGTRACKER_H
