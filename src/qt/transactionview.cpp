 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZWCCG));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
//    typeWidget->addItem(tr("Received WCCG from zWCCG"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
...
//    typeWidget->addItem(tr("Zerocoin Spend, Change in zWCCG"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zWccg));
