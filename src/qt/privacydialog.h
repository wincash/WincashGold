...
public:
    ...
    void setZWccgControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzWCCG_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzWCCG_clicked();
    void on_pushButtonZWccgControl_clicked();
