...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::WCCG);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeWincashGoldAmount"))
        SoftSetArg("-anonymizewincashgoldamount", settings.value("nAnonymizeWincashGoldAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in wincashgold.cpp during shotdown to also remove the window positions
