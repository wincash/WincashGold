                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzWCCGPathCustom = GetArg("-zwccgbackuppath", "");
    ...
    if(!strzWCCGPathCustom.empty()) {
        ui->wallet_customzwccgbackuppath->setText(QString::fromStdString(strzWCCGPathCustom));
        ui->wallet_customzwccgbackuppath_label->setVisible(true);
        ui->wallet_customzwccgbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzWCCGPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the WINCASHGOLD RPC console.") + "<br>" +
