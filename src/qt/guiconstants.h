...
/* WincashGold GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "WINCASHGOLD"
#define QAPP_ORG_DOMAIN "wincashgold.io"
#define QAPP_APP_NAME_DEFAULT "WINCASHGOLD-Qt"
#define QAPP_APP_NAME_TESTNET "WINCASHGOLD-Qt-testnet"
