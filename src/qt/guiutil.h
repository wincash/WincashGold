...
/** Utility functions used by the WINCASHGOLD Qt UI.
 */
namespace GUIUtil
{
...
// Render WINCASHGOLD addresses in monospace font
...
// Parse "wincashgold:" URI into recipient object, return true on successful parsing
