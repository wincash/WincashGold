...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("WINCASHGOLD Core"),
     ...
     * override -datadir in the wincashgold.conf file in the default data directory
     * (to be consistent with wincashgoldd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
