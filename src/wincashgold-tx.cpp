...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("WincashGold Core wincashgold-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  wincashgold-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wincashgold transaction") + "\n" +
                               "  wincashgold-tx [options] -create [commands]   " + _("Create hex-encoded wincashgold transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded wincashgold transaction
