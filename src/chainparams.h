 ...
 * WINCASHGOLD system. There are three: the main network on which people trade goods
...
public:
    ...
    int WincashGoldBadBlockTime() const { return nWincashGoldBadBlockTime; }
    int WincashGoldBadBlocknBits() const { return nWincashGoldBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nWincashGoldBadBlockTime;
    unsigned int nWincashGoldBadBlocknBits;
