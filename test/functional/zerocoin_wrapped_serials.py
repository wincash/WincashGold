...
from fake_stake.base_test import WINCASHGOLD_FakeStakeTest

class zWCCGwrappedSerialsTest(WINCASHGOLD_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zWCCGs..." % DENOM_TO_USE)
