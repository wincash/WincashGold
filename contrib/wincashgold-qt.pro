...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/wincashgold-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/wincashgold-cli.cpp \
           src/wincashgold-tx.cpp \
           src/wincashgold.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/wincashgold.qrc src/qt/wincashgold_locale.qrc

TRANSLATIONS += src/qt/locale/wincashgold_bg.ts \
                src/qt/locale/wincashgold_de.ts \
                src/qt/locale/wincashgold_en.ts \
                src/qt/locale/wincashgold_es.ts \
                src/qt/locale/wincashgold_fi.ts \
                src/qt/locale/wincashgold_fr.ts \
                src/qt/locale/wincashgold_it.ts \
                src/qt/locale/wincashgold_ja.ts \
                src/qt/locale/wincashgold_pl.ts \
                src/qt/locale/wincashgold_pt.ts \
                src/qt/locale/wincashgold_ru.ts \
                src/qt/locale/wincashgold_sk.ts \
                src/qt/locale/wincashgold_sv.ts \
                src/qt/locale/wincashgold_vi.ts \
                src/qt/locale/wincashgold_zh_CN.ts \
                src/qt/locale/wincashgold_zh_TW.ts
